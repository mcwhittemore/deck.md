...
exports.renderFile = function(path, userConfig, callback){
	...
	var mdString = fs.readFileSync(path, 'ascii');

	exports.render(mdString, userConfig, callback);

}

exports.render = function(mdString, userConfig, callback){
	if(typeof userConfig == "function"){ 
		callback = userConfig; 
		userConfig={}; 
	}
	...
	jade.render(jdString, {filename: jd_file, locals: config}, jadeback);

}

exports.renderFile(md_file, {}, function(){});